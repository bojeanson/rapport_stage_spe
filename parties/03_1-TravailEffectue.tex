...
\section{Démarche de travail}
    ...
    \subsection{Déroulement du stage}
        ...
        Ensuite, lors du dernier mois, j’ai implémenté le comportement général de cette application sous la forme d’un plugin Python (partie \ref{sec:travaux_python}). Certain composants n'existaient pas en Python, je les ai donc ré-implémentés.